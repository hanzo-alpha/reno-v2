...
use App\Filament\Clusters\ProgramBpjs\Resources\PesertaBpjsResource\Widgets\PesertaBpjsOverview;
...
//                ->disabled($this->enableInputLimitDate('bpjs'))
                ...
                ->successRedirectUrl(route('filament.admin.program-bpjs.resources.peserta-bpjs.index'))
                ->modalWidth('lg'),
        ];
    }
}
