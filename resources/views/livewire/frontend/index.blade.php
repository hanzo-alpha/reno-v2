<div>
    <section class="banner-two">
        <div class="banner-two__slider swiper">
            <div class="swiper-wrapper">
                <div class="swiper-slide">
                    <div class="banner-two__slider-single">
                        <div class="banner-two__slider-bg"
                             data-background="{{ asset('assets/images/banner/banner-two-bg.png') }}">
                        </div>
                        <div class="container">
                            <div class="row">
                ...
                <div class="swiper-slide">
                    <div class="banner-two__slider-single">
                        <div class="banner-two__slider-bg"
                             data-background="{{ asset('assets/images/banner/banner-one-bg.png') }}">
                        </div>
                        <div class="container">
                            <div class="row">
                                <div class="col-12 col-md-9  col-lg-7 col-xxl-6">
        ...
        <div class="shape-left" data-aos="fade-right" data-aos-duration="1000" data-aos-delay="300">
            <img src="{{ asset('assets/images/banner/banner-two-shape.png') }}" alt="Image">
        </div>
    ...
    <section class="difference">
                                ...
                                <div class="swiper-slide">
                                    <div class="difference__single-wrapper">
                                        <div class="difference__single difference__single-first"
                                             data-background="{{ asset('assets/images/difference/bg-one.png') }}">
                                ...
                                <div class="swiper-slide">
                                    <div class="difference__single-wrapper">
                                        <div class="difference__single difference__single-second"
                                             data-background="{{ asset('assets/images/difference/bg-two.png') }}">
                                            <div class="difference__single-thumb">
                                                <i class="icon-food"></i>
                                            </div>
                                            <div class="difference__single-content">
                                ...
                                <div class="swiper-slide">
                                    <div class="difference__single-wrapper">
                                        <div class="difference__single difference__single-third "
                                             data-background="{{ asset('assets/images/difference/bg-three.png') }}">
                                            <div class="difference__single-thumb">
        ...
        <div class="shape-hand" data-aos="fade-right" data-aos-duration="1000" data-aos-delay="300">
            <img src="{{ asset('assets/images/difference/shape-hand.png') }}" alt="Image">
        </div>
    </section>
    <!-- ==== / difference section end ==== -->
    <!-- ==== help section start ==== -->
    <section class="help" id="aboutSection">
        <div class="container">
                    ...
                    <div class="help__thumb">
                        <div class="help__thumb-inner">
                            <div class="thumb-top thumb">
                                <img src="{{ asset('assets/images/help/thumb-top.png') }}" alt="Image">
                            </div>
                            <div class="thumb-lg thumb" data-aos="fade-left" data-aos-duration="1000">
                                <img src="{{ asset('assets/images/help/thumb-lg.png') }}" alt="Image">
                ...
                <div class="col-12 col-lg-7 col-xxl-6">
                    <div class="help__content">
                        ...
                        <div class="help__content-cta cta">
                            <a href="about-us.html" aria-label="more about us" title="about us"
    ...
    <section class="cause" data-background="{{ asset('assets/images/cause/cause-bg.png') }}" id="causeSection">
        <div class="container">
                                        ...
                                        <div class="cause__slider-single">
                                            ...
                                            <div class="cause__slider-cta">
                                                ...
                                                <div class="cause__cta">
                                                    <a href="donate-us.html" aria-label="donate now"
                ...
                <div class="col-12 col-xxl-4">
                    <div class="cta-section__first cta-section__single">
                        <div class="cta-section__group" data-aos="fade-up" data-aos-duration="1000">
                            ...
                            <div class="cta-s">
                                <a href="become-volunteer.html" aria-label="become a volunteer"
                                   title="become a volunteer" class="btn--tertiary">Contact Now</a>
                            </div>
                        </div>
                        <div class="cta-img">
                            <img src="{{ asset('assets/images/cta/one.png') }}" alt="Image">
                        </div>
                    </div>
                </div>
                <div class="col-12 col-xxl-4">
                    <div class="cta-section__center cta-section__single">
                        ...
                        <div class="cta-img">
                            <img src="{{ asset('assets/images/cta/two.png') }}" alt="Image" class="parallax-image">
                        </div>
                    </div>
                </div>
                <div class="col-12 col-xxl-4">
                    <div class="cta-section__last cta-section__single">
                        ...
                        <div class="cta-img">
                            <img src="{{ asset('assets/images/cta/three.png') }}" alt="Image">
                        </div>
                    </div>
                </div>
            </div>
    ...
    <section class="community">
        ...
        <div class="community-bg">
            <img src="{{ asset('assets/images/community/community-bg.png') }}" alt="Image" class="parallax-image">
        </div>
    ...
    <section class="testimonial" data-background="assets/images/bg-one.png">
                                    ...
                                    <div class="testimonial__slider-single">
                                        ...
                                        <div class="author-info">
                                            <div class="author-thumb">
                                                <img src="{{ asset('assets/images/author.png') }}" alt="Image">
                                            </div>
        ...
        <div class="shape" data-aos="fade-right" data-aos-duration="1000" data-aos-delay="200">
            <img src="{{ asset('assets/images/community/shape.png') }}" alt="Image" class="base-img">
        </div>
    </section>
    <!-- ==== / testimonial section end ==== -->
    <!-- ==== cause slider two section start ==== -->
    <section class="cause-two" id="eventSection">
        <div class="container-fluid">
            <div class="row">
                <div class="col-12">
                        ...
                        <div class="cause-two__slider swiper">
                            <div class="swiper-wrapper">
                                <div class="swiper-slide">
                                    <div class="cause-two__slider-single">
                                        <div class="cause-thumb">
                                            <img src="{{ asset('assets/images/cause/five.png') }}" alt="Image">
                                            <a href="cause-details.html">
                                                <i class="fa-solid fa-arrow-right"></i>
                                            </a>
                                        </div>
                                ...
                                <div class="swiper-slide">
                                    <div class="cause-two__slider-single">
                                        <div class="cause-thumb">
                                            <img src="{{ asset('assets/images/cause/six.png') }}" alt="Image">
                                            <a href="cause-details.html">
                                                <i class="fa-solid fa-arrow-right"></i>
                                            </a>
                                        </div>
                                ...
                                <div class="swiper-slide">
                                    <div class="cause-two__slider-single">
                                        <div class="cause-thumb">
                                            <img src="{{ asset('assets/images/cause/seven.png') }}" alt="Image">
                                            <a href="cause-details.html">
                                                <i class="fa-solid fa-arrow-right"></i>
                                            </a>
                                        </div>
                                ...
                                <div class="difference-two__tab">
                                    <div class="difference-two__tab-btns">
                                        ...
                                        <button class="difference-two__tab-btn" data-target="#vision"
                                                aria-label="vision" title="vision">Our Vision
                                        </button>
    ...
    <section class="blog" id="blogSection">
                ...
                <div class="col-12 col-lg-6 col-xl-4">
                    <div class="blog__single-wrapper" data-aos="fade-up" data-aos-duration="1000">
                        <div class="blog__single van-tilt">
                            ...
                            <img src="{{ asset('assets/images/blog/spade.png') }}" alt="Image" class="spade-two">
                        </div>
                    </div>
                </div>
                <div class="col-12 col-lg-6 col-xl-4">
        ...
        <div class="blog-bg">
            <img src="{{ asset('assets/images/blog/blog-bg.png') }}" alt="Image">
        </div>
        <div class="spade">
