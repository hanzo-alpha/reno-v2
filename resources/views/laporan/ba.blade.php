            ...
            <div class="text-center">
                ...
                <span style="text-decoration-line: underline">
                    ...
                    <p style="font-size: 12px">
                        ...
                        {{ $record->tgl_ba->year ?? now()->year }} Bertempat di Desa/Kelurahan {{ $record->kel->name }}
                        Dilakukan
                                    ...
                                    <table style="table-layout: fixed" class="table-items table">
                                        ...
                                        @forelse($penerima as $kpm)
                                            <tr>
                                                ...
                                                <td width="10%"
                                                    class="text-center">{{ $kpm->kel()?->first()?->name }}</td>
                                                <td width="9%" class="text-right">
                                                    {{ \Illuminate\Support\Number::format($jumlahBeras, 0, locale: 'id') }}
                                                    Kg
                                                </td>
                    ...
                    $record->kelurahan)->first()->jumlah_bulan . ' bulan'}}</td>
                                        ...
                                        <tr class="total-amount">
                                            ...
                                            <td class="pr-0 text-right">
                                                {{ $record->itemBantuan()->where('kode_kelurahan', $record->kelurahan)->get()->sum('kuantitas') }}
                                                Kg
                                            </td>
                                    ...
                                    <p style="text-align: right">
                                        {{ $record->kel->name }}
                                        , {{ DateHelper::tanggal($record->tgl_ba->toString() ) }}
                                    </p><br>
