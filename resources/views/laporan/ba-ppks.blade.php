            ...
            <div class="text-center">
                ...
                <span style="text-decoration-line: underline">
                    ...
                    <p style="font-size: 12px">
                        ...
                        {{ tanggal_ke_kalimat($tglBa->format('Y-m-d') ?? now()->format('Y-m-d')) }} Bertempat di
                        Desa/Kelurahan
                        <b>{{ \Illuminate\Support\Str::upper($record->kel->name) }}</b> Dilakukan serah terima Alat
                        Bantu berupa
                    ...
                    <table style="font-size: 12px" class="table">
                        ...
                        <tr class="pb-0">
                            ...
                            <td width="87%" style="text-align: left">
                                <b>{{ setting('persuratan.nama_kepala_dinas') }}</b></td>
                        </tr>
                        <tr class="pb-0">
                            <th width="5%" style="text-align: left"></th>
                    ...
                    <p style="font-size: 12px">Untuk kewenangan masing masing dengan ini Para Pihak menyatakan dengan
                        sebenarnya bahwa :</p>
                    <ol type="a" style="font-size: 12px;">
                        <li>
                            <b>PIHAK KESATU</b>
                            menyerahkan Alat Bantu
                            berupa {{ Str::title($record->barang?->nama_barang) ?? $record->nama_bantuan }} kepada para
                    ...
                    <table style="font-size: 12px" class="table-items table">
                        ...
                        <tr>
                            <td colspan="6" class="text-center">
                                <b>Terbilang
                                    : {{ Str::ucfirst(Number::spell($record->barang?->total_harga ?? 0, 'id')) }}
                                    rupiah</b>
                            </td>
                        </tr>
                        </tbody>
                    ...
                    <p style="font-size: 12px">
                        Demikian Berita Acara Penyerahan Hasil Pekerjaan ini dibuat dalam rangkap secukupnya untuk
                        dipergunakan
